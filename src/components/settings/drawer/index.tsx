            ...
            <RootStyle {...varSidebar}>
              ...
              <Scrollbar sx={{ flexGrow: 1 }}>
                <Stack spacing={3} sx={{ p: 3 }}>
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">화면모드</Typography>
                    <SettingMode />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">명암대비</Typography>
                    <SettingContrast />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">메뉴위치</Typography>
                    <SettingDirection />
                  </Stack>
                  ...
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">색상적용</Typography>
                    <SettingColorPresets />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">수평길이</Typography>
                    <SettingStretch />
                  </Stack>
